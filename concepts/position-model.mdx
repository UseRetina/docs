...
| Field | Description |
| --- | --- |
| `source` | Data provider that surfaced the position (zerion, helius, jupiter, vybe, moralis, ledger, hyperliquid, polymarket, pendle, defilama, merkl, dropsbot, manual) |
