...
description: "How Retina runs entirely in your browser with no account or database, what stays on your device, and how a stateless proxy keeps API keys off the client."
---
