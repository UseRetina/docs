---
title: "Quickstart"
description: "Step-by-step setup wizard for first-time Retina users: unlock the app, add EVM and Solana wallets, Polymarket, manual positions, metals, then snapshot."
---
